...
export async function addChartUsingPost(
  ...
  return request<API.BaseResponseGenChartResult_>('/api/chart/gen', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** addChartAsync POST /api/chart/gen/async */
export async function addChartAsyncUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.addChartAsyncUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseGenChartResult_>('/api/chart/gen/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** addChartAsyncMq POST /api/chart/gen/async/mq */
export async function addChartAsyncMqUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.addChartAsyncMqUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseGenChartResult_>('/api/chart/gen/async/mq', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** addChartSSe POST /api/chart/gen/sse */
export async function addChartSSeUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.addChartSSeUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.SseEmitter>('/api/chart/gen/sse', {
    method: 'POST',
    params: {
      ...params,
    },
